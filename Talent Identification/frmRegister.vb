...
Public Class frmRegister
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        If txtUsername.Text = "" Or txtPassword.Text = "" Or TextBox1.Text = "" Or txtphonenumber.Text = "" Or TextEdit1.Text = "" Then
        ...
        If txtUsername.Enabled = True Then
            ...
            Try
                _con.Open()
                _cmd = New MySqlCommand("INSERT into users(usergroup,UserName,Password,Industry,Email,Surname,Forename,Phone) values ('" & ComboBoxEdit1.Text & "','" & txtUsername.Text & "', '" & txtPassword.Text & "', '" & TextEdit1.Text & "','" + Email_addressTextBox.Text + "', '" & txtsurname.Text & "', '" & txtforename.Text & "', '" & txtphonenumber.Text & "')", _con)
                ...
                smsStatus = SendSMS("TalentIdentification", "dede6abd49b9985263f9517fb03a947c", txtphonenumber.Text, "You have successfully registered for an account with Talent ID. You can now proceed to login")
        ...
        Else
            Try
                _con.Open()
                _cmd = New MySqlCommand("update users set Email='" + Email_addressTextBox.Text + "',Surname='" + txtsurname.Text + "',Forename='" + txtforename.Text + "',Phone='" + txtphonenumber.Text + "',password='" + txtPassword.Text + "',Industry='" + TextEdit1.Text + "' where UserName='" + txtUsername.Text + "' ", _con)
                _cmd.ExecuteReader(CommandBehavior.CloseConnection)
                _cmd.Dispose()
                _con.Close()
